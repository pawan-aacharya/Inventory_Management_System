...
if (isset($_POST['submit'])) {
  ...
  if (empty($category_name)) {
    ...
    $query = "INSERT INTO `categories_tbl`(`cat_name`,`unit`, `cat_status`, `created_date`) VALUES ('$category_name','$unit','$status','$created_date')";
    $result = mysqli_query($conn, $query);
    if ($result) {
      echo "<script>alert('Category Added Successfully'); window.location.href = 'Display_Category.php';</script>";
      exit;
    }
  }
}
        ...
        <div class="col">
          ...
          <div class="bg-white border rounded-5 p-2 m-3 form">
            <form action="#" method="post">
              <p class="p-2 mb-2 fw-bold text-center border bg-dark text-white"><i class="bi bi-plus"></i> Add Category
              </p>
              <div class="row">
                ...
                <div class="col-6 mb-3">
                  <div class="">
                    ...
                    <input type="text" id="form8Example1" name="unit" class="form-control" required>
                  </div>
                </div>
              </div>
              <div class="row">
