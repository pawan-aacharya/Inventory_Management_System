        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <div class="row">
                        <div class="col-10">
                            <h5 class="fw-bold">Read Messages</h5>
                        </div>
                    </div>
                    <hr>
                    <?php
                    $query = "SELECT * FROM `message` WHERE `status`='1' ORDER BY `date` ASC";
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=<?php echo $email; ?>" target="_blank" class="m-1"><button class="btn btn-primary"><i class="bi bi-envelope"></i>&nbsp;Reply</button></a>
                                           ...
                                           <p class="m-1 text-success">Readed</p>
                                        </td>
                                    </tr>
                            </tbody>
                        <?php } ?>
