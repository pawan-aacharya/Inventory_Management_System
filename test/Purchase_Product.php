...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO `cart`(`p_id`, `quantity`, `rate`) VALUES ('$product_name','$quantity','$rate')";
            ...
            <div class="row">
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col-2 mb-2"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addProductModal">Add Product</button>
                        </div>
                        <hr>
                    </div>
                            ...
                            <form action="./Purchase_Process.php" method="post">
                                ...
                                <div class="table-container">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="text-danger" href="Delete_Cart_Item.php?pid=<?php echo $pc_id; ?>"><i class="bi bi-trash-fill"></i></a>
                                                    </td>
                                                    <?php
                                    ...
                                    <div class="w-100 text-end">
                                        <strong>Total:</strong><span class="" style="margin-right: 150px;"> <?php echo $subtotal ?></span>
                                    </div>
                                    <hr>
                                    <div class="row mt-3">
